/*
coextent library. version 0.1.

1. Entity
Entity is the most basic form to work with. It supports relationships:
"[add, remove, list]Relation" and each relation can add any number of actions.
...
The "has" relation is responsible for managing the content of an entity,
what is commonly referred as fields.

The "isA" relation is responsible for managing inheritance.
...
- createdOn, createdBy, lastUpdatedOn, lastUpdatedBy, lastAccessedOn, lastAccessedBy
- type
- size
- rights !!!
- comments
...
you previously inherited from a document that was modifies you will received a 
